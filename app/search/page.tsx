...
export default function SearchPage() {
  ...
  const { topResult, grouped } = useMemo(() => {
    if (!normalizedQuery) {
      return { topResult: null as SearchResult | null, grouped: { athletes: [], coaches: [], clubs: [] } }
    }
  ...
  const hasResults =
    grouped.athletes.length > 0 || grouped.coaches.length > 0 || grouped.clubs.length > 0
