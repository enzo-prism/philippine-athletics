        ...
        {officialPartners.map((partner) => (
          ...
          >
            ...
            <div className="grid gap-3 pl-3">
              <div className="flex min-h-[102px] items-center border border-border bg-background/84 px-4 py-3 transition-[border-color,box-shadow,background-color] duration-300 group-hover:border-accent/45 group-hover:bg-white">
